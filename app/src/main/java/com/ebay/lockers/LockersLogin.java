 ...
 */
public class LockersLogin extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lockers_login);
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
       //Create adapter to tell the AutoCompleteTextView what to show in its dropdown list.
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(LockersLogin.this,
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Intent intent = new Intent(LockersLogin.this, ConfirmAcceptDialogActivity.class);
                startActivity(intent);
            } else {
