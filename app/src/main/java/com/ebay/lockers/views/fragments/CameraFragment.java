...
import com.ebay.lockers.adapters.ImagesHorizontalListAdapter;
import com.ebay.lockers.views.custom.AutoFitTextureView;
import com.ebay.lockers.views.fragments.dialogs.SaveItemDialog;
...
public class CameraFragment extends Fragment
    ...
    private ImagesHorizontalListAdapter adapter;
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            File saveFile = new File(file, "pic" + System.currentTimeMillis() + ".jpg");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new ImagesHorizontalListAdapter(getContext(), images);
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        imagesView = (RecyclerView) view.findViewById(R.id.images);
        imagesView.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false));
